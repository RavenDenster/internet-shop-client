...
const CreateDevice = observer(({show, onHide}) => {
    ...
    const changeIfo = (key, value, number) => {
  ...
  >
    ...
    <Modal.Body>
      <Form>
          ...
          <Form.Control className='mt-3' placeholder='Введите стоимость устройства' type='number' value={price} onChange={e => setPrice(Number(e.target.value))}/>
          ...
          {info.map(i =>
            <Row className='mt-4' key={i.number}>
                <Col md={4}>
                    <Form.Control
                        value={i.title}
                        onChange={(e) => changeIfo('title', e.target.value, i.number)}
                ...
                <Col md={4}>
                    <Form.Control
                        value={i.description}
                        onChange={(e) => changeIfo('description', e.target.value, i.number)}
